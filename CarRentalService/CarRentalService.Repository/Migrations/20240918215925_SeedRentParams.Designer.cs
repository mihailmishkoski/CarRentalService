...
namespace CarRentalService.Repository.Migrations
{
    ...
    [Migration("20240918215925_SeedRentParams")]
    partial class SeedRentParams
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRentalService.Domain.Models.Car", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateOnly>("DateManufactured")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("CarRentalService.Domain.Models.Identity.Customer", b =>
                {
            ...
            modelBuilder.Entity("CarRentalService.Domain.Models.Rent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CarRentalService.Domain.Models.RentParams", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ec550000-160a-4ebd-b174-64ca36f0df62"),
            ...
            modelBuilder.Entity("CarRentalService.Domain.Models.Rent", b =>
                {
                    b.HasOne("CarRentalService.Domain.Models.Car", "Car")
                        .WithMany("Rents")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarRentalService.Domain.Models.Identity.Customer", "Customer")
                        .WithMany("Rents")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CarRentalService.Domain.Models.Identity.Customer", null)
                        .WithMany()
